...
if texto_1 > texto_2:
    print(f'{texto_1} es alfabeticamente mayor que {texto_2}')
elif texto_1 < texto_2:
    print(f'{texto_1} es alfabeticamente menor que {texto_2}')
else:
    print(f'{texto_1} y {texto_2} son iguales alfabeticamente')
